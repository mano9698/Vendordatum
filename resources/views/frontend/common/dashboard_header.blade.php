...
<header id="tg-dashboardheader" class="tg-dashboardheader tg-haslayout" style="display: none;">
...
<!--                    <div class="dropdown tg-themedropdown tg-notification">
                ...
                <div id="tg-sidebarwrapper" class="tg-sidebarwrapper">
                    ...
                    <div id="tg-verticalscrollbar" class="tg-verticalscrollbar">
                        <strong class="tg-logo"><a href="javascript:void(0);"><img src="assets/images/logod.png" alt="image description"></a></strong>
                        <div class="tg-user">
                            <figure>
